...
//  if (NumEntries <= 32) {
//    return DAG.getNode(YCoreISD::BR_JT, dl, MVT::Other, Chain, TargetJT, Index);
//  }
...
//SDValue YCoreTargetLowering::LowerFRAMEADDR(SDValue Op,
//                                            SelectionDAG &DAG) const {
...
//                            RegInfo->getFrameRegister(MF), MVT::i32);
//  SDValue FrameToArgs = DAG.getNode(YCoreISD::FRAME_TO_ARGS_OFFSET, dl,
//                                    MVT::i32);
...
//  unsigned StackReg = YCore::R2;
//  unsigned HandlerReg = YCore::R3;
//
//  SDValue OutChains[] = {
...
//
//  return DAG.getNode(YCoreISD::EH_RETURN, dl, MVT::Other, Chain,
...
//    SDValue load = DAG.getNode(YCoreISD::LDWSP, dl, VTs, Ops);
//    InVals[index] = load;
...
//SDValue YCoreTargetLowering::LowerCCCCallTo(
...
//
//  CCInfo.AnalyzeCallOperands(Outs, CC_YCore);
//
...
//  RetCCInfo.AnalyzeCallResult(Ins, RetCC_YCore);
//
...
//
//      MemOpChains.push_back(DAG.getNode(YCoreISD::STWSP, dl, MVT::Other,
//                                        Chain, Arg,
...
//
//  // YCoreBranchLink = #chain, #target_address, #opt_in_flags...
