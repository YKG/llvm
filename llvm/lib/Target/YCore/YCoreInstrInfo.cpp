...
static inline YCore::CondCode GetOppositeBranchCondition(YCore::CondCode CC)
{
  switch (CC) {
  default: llvm_unreachable("Illegal condition code!");
  case YCore::COND_TRUE   : return YCore::COND_FALSE;
  case YCore::COND_FALSE  : return YCore::COND_TRUE;
  }
}
...
///
bool YCoreInstrInfo::analyzeBranch(MachineBasicBlock &MBB,
...
void YCoreInstrInfo::storeRegToStackSlot(MachineBasicBlock &MBB,
                                         MachineBasicBlock::iterator I,
...
reverseBranchCondition(SmallVectorImpl<MachineOperand> &Cond) const {
  assert((Cond.size() == 2) &&
          "Invalid YCore branch condition!");
  Cond[0].setImm(GetOppositeBranchCondition((YCore::CondCode)Cond[0].getImm()));
  return false;
}
...
MachineBasicBlock::iterator YCoreInstrInfo::loadImmediate(
